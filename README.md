...
[![Chrome Web Store](https://img.shields.io/badge/Chrome_Web_Store-Install-4caf7d?logo=googlechrome&logoColor=white)](https://stayzafu.com)
...
|---|---|---|
| **HIJACKED** | Pasted address ≠ last copied address (clipboard malware) | Red modal, diff highlighted, cancel-only |
...
Core poisoning and hijack checks run locally. Network-backed checks include GoPlus, chain-history providers, ENS resolution, and the optional community threat list.

---

## Install

**[→ Chrome Web Store](https://stayzafu.com)** — free, no account required
...
Zafu requests **4 permissions**. The average Chrome extension requests 17.

| Permission | Why |
|---|---|
| `storage` | Saves wallet list and trusted address index locally on your device |
| `tabs` | Opens address book and onboarding in a new tab |
...
- **Offline-first** — POISONED and HIJACKED detection runs with zero network calls
