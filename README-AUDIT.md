...
- **Not general PR intake.** This is a read-first audit mirror. Small fixes may be reviewed, and larger upstream changes are by maintainer invitation.
- **Not for feature requests.** Those go to https://stayzafu.com/feedback.
...
LICENSE                      MIT
CONTRIBUTING.md              contribution and fork-recognition rules
FORKS.md                     future fork recognition protocol
...
| Scam address report | Open an issue with the `malicious-report` label |
| Feature request | https://stayzafu.com/feedback |
| Bug in extension behavior | Open an issue with the `bug` label |
| Fork recognition | See [FORKS.md](FORKS.md) |
